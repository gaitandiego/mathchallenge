...
/**
 * Clase que representa el Nivel 2 del juego Math Challenge.
 * Este nivel aumenta la dificultad al introducir operaciones de multiplicación y división.
 */
public class Nivel2 implements Nivel {

    /**
     * Array que contiene las preguntas de este nivel, basadas en operaciones de 
